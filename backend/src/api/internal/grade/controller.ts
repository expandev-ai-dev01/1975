 ...
 * @apiBody {Number} gradeValue Grade value (0-10)
 ...
 * @apiParam {Number} id Grade ID
 *
 * @apiBody {Number} gradeValue New grade value (0-10)
 ...
 * @apiSuccess {Number} data.gradeValue Grade value
 * @apiSuccess {String} data.assessmentDate Assessment date
 * @apiSuccess {Number} data.calculatedAverage Calculated average for subject/period
 ...
 * @apiBody {Number} grades.gradeValue Grade value (0-10)
 *
 * @apiSuccess {Boolean} success Success flag (always true)
